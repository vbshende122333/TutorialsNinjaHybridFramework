Feature: Login Functionality
  ...
  @Smoke
  Scenario: Login with valid credentials for User 1
    ...
    @Smoke
  Scenario Outline: Login with invalid credentials for User 1
    Given User has navigate to login page
    ...
    Examples:
    | Email           | Password    |
    | (1)qab@abc.com  | ajdhajdada  |
    | (2)fqasdjakf    | jhffjkwe    |
    | (3)hfqffskjkfkd | 323232      |